...
namespace Rapid
{
    ...
    // Defines
    ////////////////////////////////////////////////////////////////////////////////////
    #if !defined(RP_CONFIG_DISTRIBUTION)
        #define RP_ASSERT(x, fmt, ...) do { if (!(x)) { ::Rapid::Logger::Fatal(fmt __VA_OPT__(,) __VA_ARGS__); NANO_DEBUG_BREAK(); } } while (false)
    #else
        #define RP_ASSERT(x, fmt, ...)
    #endif
